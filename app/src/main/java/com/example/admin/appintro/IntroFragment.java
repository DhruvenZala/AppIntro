...
public class IntroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (mPage) {
            case 0:
                layoutResId = R.layout.intro_framelayout_1;
                break;
            case 1:
                layoutResId = R.layout.intro_framelayout_2;
                break;
            case 2:
                layoutResId = R.layout.intro_framelayout_3;
                break;
            default:
                layoutResId = R.layout.intro_framelayout_4;
        }
